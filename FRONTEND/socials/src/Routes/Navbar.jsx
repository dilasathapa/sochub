    ...
    return (
        <>
            ...
            <div className={styles.seconddiv}>
                <h3 ><Link><AiFillHome className={styles.noti_icons} /><p className={styles.noti_texts}>HOME</p></Link></h3>
                <h3><Link to='/registration'><BiSearchAlt className={styles.noti_icons} /><p className={styles.noti_texts}>SEARCH</p></Link></h3>
                <h3><Link><BiLogoGithub className={styles.noti_icons} /><p className={styles.noti_texts}>G SEARCH</p></Link></h3>
                ...
                <h3><Link><BiSolidUserRectangle className={styles.noti_icons} /><p className={styles.noti_texts}>PROFILE</p></Link></h3>                
            </div>
        </>
    )
}
